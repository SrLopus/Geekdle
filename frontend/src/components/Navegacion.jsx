                ...
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center gap-8">
                        <Link to="/" className="group flex items-center gap-3 transition-all duration-300">
                            <div className="bg-white/90 rounded-full p-2.5 ring-2 ring-white/20 group-hover:bg-white group-hover:ring-white/30 transition-all duration-300 shadow-lg flex items-center justify-center w-12 h-12 relative"
                                style={{
                            ...
                            >
                                ...
                                <img 
                                    ...
                                    alt="Geekdle" 
                                    className="w-8 h-8 drop-shadow-sm relative z-10" 
                                />
                            ...
                            <span className="text-2xl font-black tracking-wider text-white group-hover:text-white transition-colors duration-300"
                                style={{
                        ...
                        <div className="flex items-center gap-1 bg-white/5 p-1 rounded-lg ring-1 ring-white/5">
                            <button
                                onClick={() => {
                                    setGameMode('daily');
                                    navigate('/juego');
                            ...
                            <>
                                <div className="relative flex items-center gap-2">
                                    <NavLink 
                                        to="/perfil" 
                                        className={({ isActive }) => 
                                            `h-10 w-10 rounded-full flex items-center justify-center text-xl font-black text-white transition-all duration-300 relative ${
                                                isActive 
                                    ...
                                    >
                                        ...
                                        <div className="absolute -bottom-1.5 -left-2 w-6 h-6 bg-black rounded-full ring-2 ring-black">
                                            ...
                                            <motion.div 
                                                ...
                                                style={{ 
                                                    ...
                                                    fontSize: `${user?.level >= 100 ? '8px' : user?.level >= 10 ? '9px' : '10px'}`,
                                                    filter: showLevelUp ? `drop-shadow(0 0 12px ${getLevelColor(user.level)})` : 'none',
                                                    transition: 'filter 0.3s ease-in-out'
                                                }}
                                            >
