                ...
                <div className="w-full max-w-md">
                    ...
                    >
                        ...
                        <motion.div className="text-center" variants={itemVariants}>
                            ...
                            <p className="text-white/60 text-sm tracking-wide">Inicia sesión para jugar</p>
                        </motion.div>
                        ...
                        <motion.form onSubmit={handleSubmit} className="space-y-6" variants={itemVariants}>
                            ...
                            >
                                ...
                                <Link to="/registro" className="text-green-500 hover:text-green-400 transition-colors duration-300">
                                    Regístrate
                                </Link>
                            </motion.p>
                        </motion.form>
